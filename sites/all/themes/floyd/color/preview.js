...
(function ($) {
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      $('#preview #preview-main-menu a', form).css('color', $('#palette input[name="palette[link]"]', form).val());
      $('#preview #preview-main-menu a.active', form).css('color', $('#palette input[name="palette[base]"]', form).val());      
